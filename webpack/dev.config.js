...
module.exports = {
  ...
  module: {
    loaders: [
      { test: /\.jsx?$/, exclude: [/node_modules/, path.resolve(__dirname, "../lib/protocol")], loaders: ['babel?' + JSON.stringify(babelLoaderQuery), 'eslint-loader']},
      ...
      { test: /\.proto(\?v=\d+\.\d+\.\d+)?$/, loader: "file" },
